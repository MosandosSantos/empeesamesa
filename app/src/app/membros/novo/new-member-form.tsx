...
type StepId = "personal" | "contact" | "ritual";
...
const steps: { id: StepId; title: string; icon: React.ComponentType<any> }[] = [
  ...
  { id: "ritual", title: "Histórico Ritualístico", icon: History },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 pb-16">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                ...
                Cadastre um novo membro na loja do tenant.
      ...
      <form onSubmit={handleSubmit} className="mx-auto mt-8 max-w-6xl px-6">
        ...
        <fieldset disabled={!hasActiveLojas} className="space-y-6">
          ...
          {/* Section 3: Histórico Ritualístico */}
          {currentStep === "ritual" && (
            <div className="space-y-6">
              <SectionCard
                title="Histórico Ritualístico"
                description="Admiss?o e situa??o atual"
                icon={History}
              >
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    label="Data de admiss?o na pot?ncia"
                    required
                  ...
                  <FormField label="Tipo de admiss?o">
                    <select
              ...
              <SectionCard
                title="Cerimônias e datas"
                description="Registro das cerim?nias e datas importantes"
                icon={History}
              >
                {/* Inicia??o */}
                <div className="rounded-lg bg-emerald-50/50 p-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    <FormField label="Data de inicia??o">
                      <input
                        type="date"
                ...
                <div className="rounded-lg bg-amber-50/50 p-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    <FormField label="Data de eleva??o">
                      <input
                        type="date"
                ...
                <div className="rounded-lg bg-purple-50/50 p-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    <FormField label="Data de instala??o">
                      <input
                        type="date"
              ...
              {currentStepIndex < steps.length - 1 ? (
                ...
                <>
                  <button
                    ...
                    className="flex h-11 items-center gap-2 rounded-lg border border-emerald-200 bg-white px-6 text-sm font-semibold text-emerald-700 shadow-sm transition-all hover:border-emerald-300 hover:bg-emerald-50"
                  >
                    Cancelar
                  </button>
                  <button
